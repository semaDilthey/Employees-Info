...
class NetworkManager {
    ...
    func fetchUsersData(requestStatus: RequestStatus, completion: @escaping (Result<Employee, Error>) -> Void) {
        getData(from: url, requestStatus: requestStatus, completion: completion)
    }
    
    private func getData<T: Decodable>(from urlString: String, requestStatus: RequestStatus, completion: @escaping (Result<T, Error>) -> Void) {
